// Чистый JS SHA-256 (без crypto.subtle), т.к. Web Crypto доступен только
// в secure context (https или http://localhost) — на телефоне по LAN-адресу
// (http://192.168.x.x) crypto.subtle отсутствует.
